# changelog — packing-completion

`packing-completion.spec.ts` の変更履歴。spec を変更したら **同じコミットで** ここに 1 行追加する（新しいものを上）。
...
- 2026-09-14 fix(e2e): フォーム入力前にハイドレーション完了を待ち、CI で落ちていた 2 件を解消（fa43114）
